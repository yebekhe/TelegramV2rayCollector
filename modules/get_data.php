    ...
    foreach ($configs as $config){
        if (substr($config, 0, 8) === "vmess://"){
                ...
                if ($ping_data !== "unavailable") {
                    ...
                    // Build the final data array with channel, type, config, and time
                    $final_data['vmess'][$array_helper_vmess]["channel"]['username'] = $channel;
                    $final_data['vmess'][$array_helper_vmess]["channel"]['title'] = $channel;
                    $final_data['vmess'][$array_helper_vmess]["channel"]['logo'] = "null";
                    $final_data['vmess'][$array_helper_vmess]["type"] = "vmess";
                    $final_data['vmess'][$array_helper_vmess]["config"] = $final_config;
                    $final_data['vmess'][$array_helper_vmess]["time"] = tehran_time();
                    $array_helper_vmess ++ ;
            }
            ...
            if ($ping_data !== "unavailable") {
                ...
                // Build the final data array with channel, type, config, and time
                $final_data['vless'][$array_helper_vless]["channel"]['username'] = $channel;
                $final_data['vless'][$array_helper_vless]["channel"]['title'] = $channel;
                $final_data['vless'][$array_helper_vless]["channel"]['logo'] = "null";
                $final_data['vless'][$array_helper_vless]["type"] = $type;
                $final_data['vless'][$array_helper_vless]["config"] = urldecode($final_config);
                $final_data['vless'][$array_helper_vless]["time"] = tehran_time();
                $array_helper_vless ++ ;
            }
            ...
            if ($ping_data !== "unavailable") {
                ...
                // Build the final data array with channel, type, config, and time
                $final_data['ss'][$array_helper_ss]["channel"]['username'] = $channel;
                $final_data['ss'][$array_helper_ss]["channel"]['title'] = $channel;
                $final_data['ss'][$array_helper_ss]["channel"]['logo'] = "null";
                $final_data['ss'][$array_helper_ss]["type"] = "ss";
                $final_data['ss'][$array_helper_ss]["config"] = urldecode($final_config);
        ...
        if ($ping_data !== "unavailable") {
            ...
            // Build the final data array with channel, type, config, and time
            $final_data['trojan'][$array_helper_trojan]['username'] = $channel;
            $final_data['trojan'][$array_helper_trojan]["channel"]['title'] = $channel;
            $final_data['trojan'][$array_helper_trojan]["channel"]['logo'] = 'null';
            $final_data['trojan'][$array_helper_trojan]["type"] = "trojan";
            $final_data['trojan'][$array_helper_trojan]["config"] = urldecode($final_config);
            $final_data['trojan'][$array_helper_trojan]["time"] = tehran_time();
            $array_helper_trojan ++ ;
        }
    }
}
